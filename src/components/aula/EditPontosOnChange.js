    ...
    return (
        ...
        {pontos ? (
            <form onSubmit={(event) => handleSubmit(event)}>
                ...
                <label>Sobre:</label><input type="sobre" name="sobre"  value={pontos.email} onChange={handleChange} />
                <label>Foto:</label><input type="foto" name="foto"  value={pontos.pass} onChange={handleChange} />
...
export default EditPontosOnChange;